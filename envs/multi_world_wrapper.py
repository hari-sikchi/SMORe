...
class ReacherGoalWrapper(Wrapper):
    ...
    def step(self, action):
        ...
        return obs_dict, reward, done,timeout, info
...
class PointGoalWrapper(Wrapper):
    observation_keys = ['observation', 'desired_goal', 'achieved_goal','state_observation','state_desired_goal','state_achieved_goal']
    def __init__(self, env):
...
class SawyerGoalWrapper(Wrapper):
    ...
    observation_keys = ['observation', 'desired_goal', 'achieved_goal','state_observation','state_desired_goal','state_achieved_goal','proprio_observation','proprio_desired_goal','proprio_achieved_goal']
